	...
	render() {
		return (
			<>
				<nav
					className="navbar"
					style={{ background: "#f1eee9", zIndex: 1 }}
					role="navigation"
				...
				>
					...
					<div id="navbarBasicExample" className={`navbar-menu ${this.state.active ? "is-active": ""}`}>
						<div className="navbar-end">
							<a href="/" className="navbar-item navbox item">
								Home
							</a>
							<a href="/products" className="navbar-item navbox item">
								Products
							</a>
							...
							<a
								...
								className="navbox item snipcart-checkout snipcart-summary"
								href="#"
							>
								<svg
